...
@section('title', 'IProspect Timesheet Create')
    ...
    <div class="row m-0 page-container" style="padding-bottom:8vw">
        ...
        <div class="col-12 p-0">
            ...
            <div style="padding:1vw 2vw;background:#F1F1F1;margin-top:0.5vw;border-radius:1vw;display:flex;align-items:center;justify-content:space-between">
                ...
                <p class="btn-grey px-24"style="width:auto;text-align:center;font-weight:bold;padding-left:2vw;padding-right:2vw;margin-bottom:0px">{{auth()->user()->name}}</p>
        ...
        <div class="col-12" style="padding:0vw 5vw">
            ...
            <div style="padding:1.5vw 5vw;background:#F1F1F1;margin-top:2vw;border-radius:1vw;">
                <div style="display:flex;justify-content:space-between;">
                    <div>
                        ...
                        <input type="date" name="start_date" class="px-18" style="width:15vw" required>
                        @error('start_date')
                        <br>
                    ...
                    <div>
                        ...
                        <input type="date" name="end_date" class="px-18" style="width:15vw" required>
                        @error('end_date')
                        <br>
                        <strong class="px-18" style="color:red">{{ $message }}</strong>
                        @enderror
                    ...
                    <div style="padding:1.5vw 5vw;background:#F1F1F1;margin-top:2vw;border-radius:1vw;">
                        ...
                        <div style="display:flex;justify-content:space-between;margin-top:2vw;align-items:center">
                            ...
                            <div>
                                <p class="px-18" style="margin-bottom:0px;color:#3A8D1C;">Work Hours:
                                    <span class="px-24">
                                        <input type="number" min='0' style="width:3vw;text-align:center" required name="workinghours[]" id="workhours">
                                        @error('workhours')
                                            <br>
                                            <strong class="px-18" style="color:red">{{ $message }}</strong>
                                        @enderror  
            ...
            <div style="padding:1.5vw 5vw;background:#F1F1F1;margin-top:5vw;border-radius:1vw;">
                <div style="text-align:right">
                    <p class="px-18" style="margin-bottom:0px;color:#3A8D1C;">Total Working Hours: <span class="px-24"><input type="number" min='0' style="width:3vw;text-align:center" name="total_working_hours" id="total_working_hours" required></span></p>
            ...
            <div style="display:flex;justify-content:center;margin-top:2vw">
                <button value="save" name="submission_type" class="btn-orange px-24" type="submit" style="margin-right:2vw">Save - In Progress</button>
                <button value="submit" name="submission_type" class="btn-grey px-24" type="submit" style="margin-left:2vw" >Submit For Approval</button>
